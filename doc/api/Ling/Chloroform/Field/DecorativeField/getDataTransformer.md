...
Source Code
===========
See the source code for method [DecorativeField::getDataTransformer](https://github.com/lingtalfi/Chloroform/blob/master/Field/DecorativeField.php#L165-L168)
